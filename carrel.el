...
(insert-file-contents "~/Documents/emacs/fileEmacs/fonti.el")
     (goto-char (point-min))
    (let ((regexp (concat    "\\(.*\\)"
                             (eval ter)
                            )))
...
(end-of-buffer)
(setq punto2 (point))
(write-region punto1 punto2 "~/Documents/emacs/fileEmacs/fonti.el")
...
(setq punto1 (point))
(write-region 1 punto1 "~/Documents/emacs/fileEmacs/listafonti.el")
(kill-buffer "Fonti")
...
(insert cd)
(setq punto (point))
(write-region 1 punto "~/Documents/emacs/fileEmacs/fonti.el" 'append)
