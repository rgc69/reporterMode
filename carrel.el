...
(insert-file-contents "/home/rgc/Documents/emacs/fileEmacs/fonti.el")
     (goto-char (point-min))
    (let ((regexp (concat    "\\(.*\\)"
                             (eval ter)
                            )))
...
(end-of-buffer)
(setq punto2 (point))
(write-region punto1 punto2 "/home/rgc/Documents/emacs/fileEmacs/fonti.el")
...
(setq punto1 (point))
(write-region 1 punto1 "/home/rgc/Documents/emacs/fileEmacs/listafonti.el")
(kill-buffer "Fonti")
...
(end-of-buffer)
(setq punto2 (point))
(write-region punto1 punto2 "/home/rgc/Documents/emacs/fileEmacsfonti.el")
...
(insert cd)
(setq punto (point))
(write-region 1 punto "/home/rgc/Documents/emacs/fileEmacs/fonti.el" 'append)
(load "/home/rgc/Documents/emacs/fileEmacs/fonti.el")
