...
(setq punto1 (point))
(write-region 1 punto1 (concat *home* "/Documents/emacs/fileEmacs/fonti.el"))
(kill-buffer "Fonti")
(format "
...
(end-of-buffer)
(setq punto2 (point))
(write-region punto1 punto2 (concat *home* "/Documents/emacs/fileEmacs/listafonti.el"))
(kill-buffer "Eliminazioni"))
...
(elimina-relazione)
(progn
(load (concat *home* "/Documents/emacs/fileEmacs/listafonti.el"))
(setq numero-hash (hash-table-count (eval *miotermine*)))
( VisualizzazioneAssociazioni2)
(sub1))))
